...
const EN = {
  ...
  eulaAccepted:"Current agreement already accepted.",
    ...
    authWorking:"Working…",
    authRegistrationSent:"Registration submitted. We sent a confirmation email; the account becomes active after email confirmation.",
...
const DICT = {
  ...
  hu: {
    ...
    authRegistrationSent:"Regisztráció elküldve. Küldtünk egy megerősítő e-mailt; a fiók az e-mail-cím megerősítése után lesz aktív.",
  ...
  nl: {
    ...
    authWorking:"Bezig…",
    authRegistrationSent:"Registratie verzonden. We hebben een bevestigingsmail gestuurd; het account wordt actief na bevestiging.",
  ...
  ro: {
    ...
    authRegistrationSent:"Înregistrarea a fost trimisă. Am trimis un e-mail de confirmare; contul devine activ după confirmare.",
  ...
  pl: {
    ...
    authRegistrationSent:"Rejestracja wysłana. Wysłaliśmy e-mail potwierdzający; konto zostanie aktywowane po potwierdzeniu.",
  ...
  hr: {
    ...
    authWorking:"Obrada…",
    authRegistrationSent:"Registracija je poslana. Poslali smo e-mail za potvrdu; račun postaje aktivan nakon potvrde.",
  ...
  be: {
    ...
    authRegistrationSent:"Рэгістрацыя адпраўлена. Мы адправілі ліст пацверджання; акаўнт стане актыўным пасля пацверджання.",
